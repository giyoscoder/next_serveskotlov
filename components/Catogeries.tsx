                ...
                <div className='grid grid-cols-1 md:grid-cols-6 gap-6 md:gap-8 mt-12 md:mt-16'>
                    ...
                    <div className='md:col-span-3 p-5 md:p-6 rounded-xl bg-[#F9FAFB]'>
                        <Swiper loop={true} onSwiper={(swiper: any) => {
                            ...
                            <SwiperSlide><Image width={500} height={500} src={first_slider_one} alt="contour_img" className='md:rounded-lg mx-auto max-h-[240px] w-full' /></SwiperSlide>

                            <SwiperSlide><Image width={500} height={500} src={first_slider_two} alt="contour_img" className='md:rounded-lg mx-auto  max-h-[240px] w-full' /></SwiperSlide>

                            <SwiperSlide><Image width={500} height={500} src={first_slider_three} alt="contour_img" className='md:rounded-lg mx-auto  max-h-[240px] w-full' /></SwiperSlide>
                    ...
                    <div className='md:col-span-2 p-5 md:p-6 rounded-xl bg-[#F9FAFB]'>
                        <Swiper loop={true} onSwiper={(swiper: any) => {
                            ...
                            <SwiperSlide><Image width={500} height={500} src={third_slider_one} alt="contour_img" className='md:rounded-lg mx-auto max-h-[240px] w-full' /></SwiperSlide>
